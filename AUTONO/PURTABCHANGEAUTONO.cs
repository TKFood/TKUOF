...
{
    class PURTABCHANGEAUTONO : Ede.Uof.WKF.ExternalUtility.IFormAutoNumber
    {
        string TRACK_ID = "PURTACHANGE";
        public void Finally()
        {
        ...
        public string GETMAXNO(string CURRENT_NO)
        {
            ...
            {
                int POS = TRACK_ID.Length + 8;
                string NO = CURRENT_NO.Substring(POS, 4);
